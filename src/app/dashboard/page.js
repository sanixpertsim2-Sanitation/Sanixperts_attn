    ...
    <div className="space-y-8">
      ...
      <div className="lg:hidden">
        ...
        <div className="mt-4 space-y-4">
          ...
          {activeTab === "alerts" && highSeverity.length > 0 && (
          ...
          {activeTab === "alerts" && highSeverity.length === 0 && (
            <div className="rounded-2xl border border-slate-700/70 bg-slate-900/60 p-4 text-sm text-slate-400">
              No high-severity alerts right now.
            </div>
          )}
      ...
      {highSeverity.length > 0 && (
        <div className="hidden rounded-2xl border border-red-500/40 bg-red-500/10 p-4 text-red-100 animate-pulse md:block">
          <p className="text-sm font-semibold">
            HIGH SEVERITY DAMAGE ALERT
          </p>
          <ul className="mt-2 space-y-1 text-xs">

...
export default function MacyPalletizingChecklistPage() {
  ...
  const stageCards = [
    ...
    },
    {
      ...
      status: handoverNeeded
        ? state.stages.handover
          ...
          : "Locked"
        : "Not Required",
      href: handoverEnabled ? "/macy/palletizing/handover" : null,
    ...
    },
    {
      ...
      status: state.stages.lead
        ...
        ? "Ready"
        : "Locked",
      href: leadEnabled ? "/macy/palletizing/lead" : null,
  ...
  return (
    <div className="space-y-8">
      {/* Line Announcements */}
      <AnnouncementBanner lineName="MACY Palletizing" />
      ...
      <LineReportSummary lineName="MACY Palletizing" />

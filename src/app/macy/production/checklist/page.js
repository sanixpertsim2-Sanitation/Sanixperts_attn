...
export default function MacyProductionChecklistPage() {
  ...
  const leadEnabled =
    state.stages.postClean && (!handoverNeeded || state.stages.handover);
  ...
  const stageCards = [
    ...
    },
    {
      ...
      status: handoverNeeded
        ? state.stages.handover
          ...
          : "Locked"
        : "Not Required",
      href: handoverEnabled ? "/macy/production/handover" : null,
    ...
    },
    {
      ...
      status: state.stages.lead
        ...
        ? "Ready"
        : "Locked",
      href: leadEnabled ? "/macy/production/lead" : null,

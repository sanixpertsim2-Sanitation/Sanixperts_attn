...
export default function MacySpiralChecklistPage() {
  ...
  const stageCards = [
    ...
    },
    {
      ...
      status: handoverNeeded
        ? state.stages.handover
          ...
          : "Locked"
        : "Not Required",
      href: handoverEnabled ? "/macy/spiral/handover" : null,
    ...
    },
    {
      ...
      status: state.stages.lead
        ...
        ? "Ready"
        : "Locked",
      href: leadEnabled ? "/macy/spiral/lead" : null,
  ...
  return (
    <div className="space-y-8">
      {/* Line Announcements */}
      <AnnouncementBanner lineName="MACY Spiral" />
      ...
      <LineReportSummary lineName="MACY Spiral" />

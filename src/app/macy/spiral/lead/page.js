...
export default function SpiralLeadVerificationPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-indigo-200">
        MACY Spiral - Area Verification
      </h1>

      <DamageAcknowledgement lineName="MACY Spiral" />
      ...
      {leadChecklistDone && <AreaLeadSignOff lineName="MACY Spiral" />}
    </div>
  );
}
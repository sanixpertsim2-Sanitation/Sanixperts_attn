...
const cards = [
  {
    ...
    description: "Pre-clean and post-clean verification for Macy Oven.",
    href: "/macy/oven/checklist",
  },
  {
    title: "Damage Report",
...
export default function MacyOvenPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-blue-200">MACY Oven</h1>
